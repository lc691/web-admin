...
from .helpers import format_song_response, get_artist_channel_id, validate_song_data
from .models import ExportPreviewPayload

from app.music.repositories.export.types import ExportMode
from app.music.services.export.service import export
...
@router.get("/songs/export/day/{day}/remaining")
def remaining(
    day: int,
...
# BULK DELETE USAGE
# ===========================
@router.post("/songs/usage/bulk-delete")
...
# ===========================
@router.get("/songs/usage/selected", response_class=HTMLResponse)
...
@router.get("/songs/youtube-generator", response_class=HTMLResponse)
def youtube_generator_page(request: Request):
    return templates.TemplateResponse("songs/v1/generate.html", {"request": request})


# ===========================
# LIST EXPORT BATCHES
# ===========================
@router.get("/songs/export/batches", response_class=HTMLResponse)
...
# BATCH DETAIL
# ===========================
@router.get("/songs/export/batches/{batch_id}", response_class=HTMLResponse)
...
# DELETE EXPORT BATCH
# ===========================
@router.post("/songs/export/batches/{batch_id}/delete")
def delete_export_batch(
    ...
    return RedirectResponse(url="/songs/export/batches", status_code=HTTP_302_FOUND)


# ===========================
# CLEAR SONG USAGE
# ===========================
@router.post("/songs/usage/clear")
...
# ===========================
@router.post("/songs/export/batches/clear")
...
# EXPORT PREVIEW
# ===========================
@router.post("/songs/export/preview")
def export_preview(
